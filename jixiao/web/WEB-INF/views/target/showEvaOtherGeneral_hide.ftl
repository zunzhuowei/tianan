...
<table class="t1" id="liangHuaLeiZhiBiao">
    <tbody>
    <tr class="firstRow">
        <td valign="top" style="word-break: break-all;" rowspan="1"
            colspan="12" style="background:yellow"><span
                style="font-size: 14px; color: #836FFF"><b>第一部分：计划考核指标（70%）</b></span>
        </td>
    </tr>
    <tr>
	...
	<#list taps as tap>
    <tr id="${tap.p04.p0400 }" style="display:none"><!-- onclick="changeRow(this)" -->
        ...
        <td width="60" valign="middle" align="center" colspan="1"
            rowspan="1" style="word-break: break-all;" id="otherGeneralRank">
			<#if tap.target != null>
        ...
        <td width="60" valign="middle" align="center" colspan="1"
            ...
            <input type="text" value="${tap.evaluationSelfOther.otherScore }" onchange="autoSaveEvaValue1(this)" name="oScore" style="width: 100%"/>
        </td>
    </tr>
	</#list>
    <!-- ==================================================================================================== -->
    <tr id="lh" style="display:none">
        <td valign="middle" align="left" colspan="12" rowspan="1"
            style="word-break: break-all;; background: #EDEDED"><span
                style="font-size: 12px"> <span
	...
	<#list sapes as sape>
    <tr id="${sape.secondP04.p0400 }" style="display:none"><!-- onclick="secondChangeRow(this)" -->
        ...
        <td valign="middle" align="center" colspan="1" rowspan="1"
            style="word-break: break-all;" id="otherGeneralRank">
    ...
    <tr id="${cdas.common2Desc.point_id }" onclick="getChangeScore(this)"><!--  onclick="getChangeScore(this)" -->
        ...
        <td valign="middle" align="center" colspan="1" rowspan="1"
            style="word-break: break-all;" id="otherGeneralRank2">
    ...
    <tr id="tyl" style="display:none">
        <td valign="middle" align="left" colspan="10" rowspan="1"
            style="word-break: break-all;; background: #EDEDED"><span
                style="font-size: 12px;">量化、非量化、通用类分数小计：</span></td>
...
<table class="t1" id="tongYongLeiBPI" style="display:none">
    <tbody>
    <tr class="firstRow">
        <td valign="top" style="word-break: break-all;" rowspan="1"
            colspan="12" style="background:yellow"><span
                style="font-size: 14px; color: #836FFF"><b>第二部分：BPI考核指标（30%）</b></span>
        </td>
    </tr>
    <tr>
    ...
    <tr id="tyl">
        <td valign="middle" align="left" colspan="4" rowspan="1"
            style="word-break: break-all;; background: #EDEDED"><span
                style="font-size: 12px;">BPI类分数小计：</span></td>
        <td valign="middle" align="left" colspan="2" rowspan="1"
            style="word-break: break-all;color: #412014;; background: #EDEDED"><span
                style="font-size: 12px;" id="nowRecordBPI"></span></td>
    </tr>
    <tr id="tyl">
    ...
    <tr>
        <td valign="middle" align="center" colspan="6" rowspan="1"
            style="word-break: break-all;">
            <#--<textarea style="width: 100%;height: 120px" id="gouTongYuFanKui" name="" onchange="saveFeedBack(this)">${feedBack.feedBack}</textarea>-->
            <textarea style="width: 100%;height: 120px" id="gouTongYuFanKui" name="" onchange="saveFeedBack(this)"></textarea>
        </td>
    </tr>
    </tbody>
</table>
...
<script type="text/javascript">
    ...
    function refashRecord2(e) {//实时显示自评分数
        ...
        if(tableId != undefined){
            for(var i=4;i<tableId.rows.length;i++){
                ...
                for(var j=0;j<cellList.length;j++){//scoreEva
                    if (cellList[j].id == "otherGeneralRank2") {
                        var rankText = parseFloat(cellList[j].innerText);
                        //alert(cellList[j + 2].id);
                        if(cellList[j+2].id == "scoreEva"){
    ...
    function refashRecord1(e) {//实时显示自评分数
        var tableId = e.parentNode.parentNode.parentNode;
        var flag = 0;
        if(tableId != undefined){
            for(var i=4;i<tableId.rows.length;i++){
    ...
    function autoSaveEvaValue1(e){
        ...
        if (name == "sScore" && !IsNumeric1(value)) {
            ...
            var returnScore = refashRecord1(e);
            if (returnScore == undefined) {
                e.value = 0;
                return ;
            }
    ...
    function saveCommonScore(e){/////////////////////////////////////////
        ...
        var returnScore = refashRecord2(e);
        if (returnScore == undefined) {
            e.value = 0;
            return ;
        }
    ...
    function saveCommonScoreBPI(e){/////////////////////////////////////////
        ...
        //refashRecordBPI(e);
        var returnScore = refashRecordBPI(e);
        if (returnScore == undefined) {
            e.value = 0;
            return ;
        }
