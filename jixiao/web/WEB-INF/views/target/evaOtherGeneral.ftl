    ...
    <tr id="${cdas.common2Desc.point_id }" onclick="getChangeScore(this)"><!--  onclick="getChangeScore(this)" -->
        ...
        <td valign="middle" align="center" colspan="2" rowspan="1"
			...
			<#if cdas.commonScore != null>
                <input type="text" disabled="disabled" onchange="saveCommonScore(this)" value="${cdas.commonScore.score }" name="Score" style="width: 100%"/>
			<#else>
                <input type="text" disabled="disabled" onchange="saveCommonScore(this)" value="" name="Score" style="width: 100%"/>
			</#if>
        </td>
    </tr>
	</#list>
